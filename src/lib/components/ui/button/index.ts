...
export const buttonVariants = tv({
	...
	variants: {
		variant: {
			default:
				'bg-academic-primary text-white hover:bg-academic-primary-dark shadow-sm hover:shadow-md',
			destructive: 'bg-academic-error text-white hover:bg-red-700',
			outline:
				'border border-academic-gray-300 bg-academic-paper hover:bg-academic-gray-50 text-academic-gray-700 hover:text-academic-gray-900',
